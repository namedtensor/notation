...
A \emph{shape} is a set of pairs written as $\tuple{\name{i}_1: X_1, \ldots, \name{i}_r: X_r}$ where $X_1, \ldots, X_r$ are sets. We use shapes to define sets of named tuples:
\begin{equation*}
